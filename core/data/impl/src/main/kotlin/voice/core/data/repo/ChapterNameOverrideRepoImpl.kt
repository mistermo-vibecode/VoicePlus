...
public class ChapterNameOverrideRepoImpl(private val dao: ChapterNameOverrideDao) : ChapterNameOverrideRepo {

  override fun overridesForBook(bookId: BookId): Flow<List<ChapterNameOverride>> = dao.overridesForBook(bookId.value)
