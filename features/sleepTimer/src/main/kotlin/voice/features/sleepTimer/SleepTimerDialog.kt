...
fun SleepTimerDialog(
  ...
  onIncrementChapterCount: () -> Unit = {},
  onDecrementChapterCount: () -> Unit = {},
  ...
  ModalBottomSheet(
    ...
    Column {
      ...
      ListItem(
        ...
        colors = ListItemDefaults.colors(containerColor = Color.Transparent),
        headlineContent = {
          Text(text = chapters(count = viewState.chapterCount))
        },
        supportingContent = {
          Text(text = stringResource(id = StringsR.string.end_of_chapter_subtitle))
        },
        trailingContent = {
          Row {
            ContinuousPressIcon(
              onEmit = onDecrementChapterCount,
              icon = Icons.Outlined.Remove,
              contentDescription = stringResource(id = StringsR.string.sleep_timer_button_decrement),
            )
            ContinuousPressIcon(
              onEmit = onIncrementChapterCount,
              icon = Icons.Outlined.Add,
              contentDescription = stringResource(id = StringsR.string.sleep_timer_button_increment),
            )
          }
...
@Composable
@ReadOnlyComposable
private fun chapters(count: Int): String {
  return pluralStringResource(StringsR.plurals.end_of_chapter_count, count, count)
}
