...
internal fun BackupScreen(
  ...
  // Deleting a save is irreversible — for a data-protection feature, a mis-tap must not destroy one.
  var pendingDelete by remember { mutableStateOf<BackupEntry?>(null) }
  pendingDelete?.let { entry ->
    AlertDialog(
      onDismissRequest = { pendingDelete = null },
      title = { Text(stringResource(StringsR.string.backup_delete_save)) },
