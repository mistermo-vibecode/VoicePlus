...
fun BookOverviewScreen(modifier: Modifier = Modifier) {
  ...
  BookOverview(
    ...
    categoryExpanded = { category ->
      when (category) {
        BookOverviewCategory.NOT_STARTED -> notStartedExpanded
        BookOverviewCategory.FINISHED -> finishedExpanded
        else -> true
      }
    },
    onCategoryToggle = bookOverviewViewModel::toggleCategoryExpanded,
  )
